...
export const CHART_INFO: Record<string, ChartInfoContent> = {
  trend: {
    title: '现货价格趋势图',
    tradingMeaning:
      '本图用于展示目标行情指标在全天各时段的变化趋势。\n\n用户可对比"交易中心在不同披露时点给出的参考口径""市场出清结果""事后实际值"以及"系统智能预测值"，从而判断市场价格或功率走势的演变过程，并辅助储能充放电与报量报价决策。\n\n【如何解读】\n如果"智能预测"与"出清前下午"较为接近，说明系统对临近出清行情的识别较好；\n如果"出清后"与"实际"存在明显差异，则说明市场运行后仍有偏差修正或实时变化；\n如果某些时段价差明显拉大，通常意味着储能套利空间更强。\n\n【演示讲解词】\n这张图不是只看一条价格曲线，而是把同一个指标在不同披露阶段的口径放在一起。\n客户可以看到，从交易中心上午披露、下午更新、出清结果，到最终实际值，整个市场认知是如何逐步收敛的。\n我们的"智能预测"则是站在正式结果披露之前，帮助用户提前做判断和策略准备。',
    calculationLogic:
